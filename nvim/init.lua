...
vim.opt.linebreak = true -- break lines by default
vim.opt.spell = true -- spell check by default
...
local function lsp_on_attach(ev)
	...
	vim.keymap.set("n", "<leader>fd", function()
		require("fzf-lua").lsp_definitions({ jump_to_single_result = true })
	end, vim.tbl_extend("force", opts, { desc = "Show file definitions" }))
	vim.keymap.set("n", "<leader>fr", function()
		require("fzf-lua").lsp_references()
	end, vim.tbl_extend("force", opts, { desc = "Show references" }))
	vim.keymap.set("n", "<leader>ft", function()
		require("fzf-lua").lsp_typedefs()
	end, vim.tbl_extend("force", opts, { desc = "Show type definitions" }))
	vim.keymap.set("n", "<leader>fs", function()
		require("fzf-lua").lsp_document_symbols()
	end, vim.tbl_extend("force", opts, { desc = "Show document symbols" }))
	vim.keymap.set("n", "<leader>fw", function()
		require("fzf-lua").lsp_workspace_symbols()
	end, vim.tbl_extend("force", opts, { desc = "Show workplace symbols" }))
