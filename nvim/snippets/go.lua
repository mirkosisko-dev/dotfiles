...
ls.add_snippets("go", {
	...
	s(
		{ trig = "fumh", descr = '(fumh) "http handler function on receiver"', priority = -1000, trigEngine = te("w") },
		{
			t("func ("),
			i(1, "receiver", { key = "i1" }),
			t(" "),
	...
	s(
		{ trig = "gg", descr = '(gg) "Grouped globals with anonymous struct"', priority = -1000, trigEngine = te("w") },
		{
			t("var "),
			i(1, "var", { key = "i1" }),
			t(" = struct{"),
	...
	s({
		trig = "^import",
		descr = '(^import) "Import declaration"',
		priority = -50,
		trigEngine = te("r"),
		regTrig = true,
	}, {
	...
	s({
		trig = "^cons",
		descr = '(^cons) "Constants declaration"',
		priority = -50,
		trigEngine = te("r"),
		regTrig = true,
	}, {
	...
	s(
		{ trig = "^con", descr = '(^con) "Constant declaration"', priority = -50, trigEngine = te("r"), regTrig = true },
		{
			t("const "),
			i(1, "name", { key = "i1" }),
			tr(2, "(.+)", " "),
